  ...
  return (
    <nav className="flexBetween w-full fixed z-10 p-4 flex-row border-b dark:bg-nft-dark bg-white dark:border-nft-black-1 border-nft-gray-1">
      <div className="flex flex-1 flex-row justify-start">
        <Link href={"/"} className="flexCenter md:hidden cursor-pointer">
           <Logo title={'Nestio'}/>
        </Link>
        <Link href={"/"}>
      ...
      <div className="hidden md:flex ml-2">
        ...
        )}
        {
             ...
             isOpen &&   (<div className={`transition-opacity ${isOpen ? 'opacity-100' : 'opacity-0'} fixed inset-0 top-65 dark:bg-nft-dark bg-white z-10 nav-h flex justify-between flex-col`}>
